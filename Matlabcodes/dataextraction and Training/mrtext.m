...
%     address4=sprintf('mouth%d.jpg',numold4);
    ...
    addresstxt=sprintf('bbox%d.txt',numold);
...
%      add4='C:\Users\Navid\Desktop\NAVID\work\Deutschland\dataset\mouth\';
     ...
     fileID = fopen([add addresstxt],'w');
   
    
    fprintf(fileID,' %d %d %d %d\r\n',bboxPoints(1),bboxPoints(2),bboxPoints(3),bboxPoints(4));
    fprintf(fileID,' %d %d %d %d\r\n',bboxPoints2(1),bboxPoints2(2),bboxPoints2(3),bboxPoints2(4));
    fprintf(fileID,' %d %d %d %d\r\n',bboxPoints3(1),bboxPoints3(2),bboxPoints3(3),bboxPoints3(4));
    fprintf(fileID,' %d %d %d %d\r\n',bboxPoints4(1),bboxPoints4(2),bboxPoints4(3),bboxPoints4(4));
